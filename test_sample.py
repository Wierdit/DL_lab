...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='LAPAR_A_x4.pth')
    parser.add_argument('--input_path', type=str, default='./demo/SISR/LR_imgs')
    parser.add_argument('--output_path', type=str, default='./demo/SISR/output')
